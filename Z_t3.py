...
MODO = 1 # SELECIONAR 1 PARA WIREFRAME, 2 PARA NAO TRANSPARENTE, 3 PARA ILUMINADO
...
def sweep_3D (object_2D, depth):
    ...
    object_3D += [copia_face_principal_para_plano_z(object_2D, depth)] # sera revertido no final
    pts = len(object_2D)
    for v in range(pts):
