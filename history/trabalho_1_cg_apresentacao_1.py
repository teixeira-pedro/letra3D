...
class Aresta:
    def __init__(self,p_i,p_f,g):
        ...
        ##fazer uma funcao so pra desenhar ele ???? fora das classes ????
...
#            print('desenhando:',tela,cor,SR.SRU_2_py(aresta._I()),SR.SRU_2_py(aresta._F()),aresta.grossura())
#            pygame.draw.line(tela,cor,SR.SRU_2_py(aresta._I()),SR.SRU_2_py(aresta._F()),aresta.grossura())
    #        pygame.display.update()
            print('desenhando:',tela,cor,aresta._I(),aresta._F(),aresta.grossura())
            pygame.draw.line(tela,cor,[aresta._I()[0],100-aresta._I()[1]],[aresta._F()[0],100-aresta._F()[1]],aresta.grossura())
...
#criando objeto
O_l=Objeto2D([50,0])
O_l.print()###  #GIRAR 90º, TA ERRADO O L
